export const projects = [
    {
        id: "chess-engine",
        title: "Chess Web App",
        description: "My Capstone project at UIS, a team-developed chess web app. It supports online matches between players & includes a minimax AI opponent for players to practice against. The app is built with a React/Typescript frontend, a Java engine, and a Spring API. My contributions in this project were the Java based chess engine and the creation of AI agents.",
